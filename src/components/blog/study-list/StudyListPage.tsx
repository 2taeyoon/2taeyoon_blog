      ...
      <div className="wrap">
        ...
        <div className="common_wrap">
          <div className="study_search_wrap">
            <input id="studySearch" type="text" className="study_search_input" placeholder="제목, 내용, 해시태그로 검색..." 
							value={searchQuery} onChange={(e) => handleSearch(e.target.value)} />
            {searchQuery && (
              <button type="button" className="study_search_clear" onClick={() => handleSearch("")} aria-label="검색어 지우기">
          ...
          <CardPagination filteredCards={filteredCards} sessionName={sessionName} currentPage={currentPage} setCurrentPage={setCurrentPage} />
        </div>
      </div>
    </div>
  );
