...
import DesignCard from "@/data/blog/designData.json";
import DesignStudyContent from "@/app/blog/design/[title]/DesignStudy";
...
export async function generateMetadata({ params }: { params: Promise<{ title: string }> }) { // 동적 경로 매개변수인 params로 URL 가져옴
  ...
  return {
    ...
    openGraph: {
      title: DesignCardFind.title,
      description: DesignCardFind.subTitle,
      url: `https://www.2taeyoon.com/blog/design/${decodedTitle}`,
			images: [
				{
